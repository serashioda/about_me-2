...
console.log(answer1);
if (answer1 === 'no'.toUpperCase() || answer1 === 'n'.toUpperCase()) {
...
console.log(answer2);
if (answer2 === 'yes'.toUpperCase() || answer2 === 'y'.toUpperCase()) {
...
console.log(answer3);
if (answer3 === 'yes'.toUpperCase() || answer3 === 'y'.toUpperCase()) {
...
console.log(answer4);
if (answer4 === 'yes'.toUpperCase() || answer4 === 'y'.toUpperCase()) {
...
console.log(answer5);
if (answer5 === 'no'.toUpperCase() || answer5 === 'n'.toUpperCase()) {
